  ...
  <div>
    <b-col md="12">
      ...
      <b-form @submit="register">
        <b-col md="12">
          <b-avatar class="mt-3" size="120" icon="person-fill" :src="img"></b-avatar>
        </b-col>
        <b-col md="12">
          <b-row class="">
            ...
            <b-col md="12">
              <b-form-group id="tipo" class="col-8 mt-5">
                <b-row>
                  <b-form-radio v-model="selected" name="some-radios" class="opt1 ml-4" value="docente">Docente</b-form-radio>
                  <b-form-radio v-model="selected" name="some-radios" class="opt2 ml-4" value="não docente">Não Docente</b-form-radio>
                </b-row>
              </b-form-group>
            </b-col>
